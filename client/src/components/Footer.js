...
const Footer = () => {
  return (
    <footer id="page-footer" class="bg-blue-900">
      <div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div class="space-y-6">
            <h4 class="text-sm uppercase font-semibold tracking-wider text-blue-300">
              Products
            </h4>
            <nav class="flex flex-col space-y-3">
              <a
                href="javascript:void(0)"
                class="font-medium text-white hover:opacity-75"
              >
                Solutions
              </a>
              <a
          ...
          <div class="space-y-6">
            ...
            >
              <div class="sm:flex-grow">
                <label for="tk-footer-email" class="sr-only">
                  Email
                </label>
                <input
                  class="block border placeholder-gray-400 py-2 leading-5 text-sm w-full rounded border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                  type="email"
                  id="tk-footer-email"
                  placeholder="Email"
                />
          ...
          <nav class="space-x-4">
            ...
            >
              <svg
                ...
                class="icon-twitter inline-block w-5 h-5"
              >
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                class="icon-facebook inline-block w-5 h-5"
              >
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                class="icon-instagram inline-block w-5 h-5"
              >
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                class="icon-github inline-block w-5 h-5"
              >
