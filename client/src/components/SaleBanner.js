    ...
    <>
      <div class="fixed top-0 inset-x-0 z-60 flex justify-between items-center p-3 sm:py-5 sm:px-8 shadow-lg bg-blue-600">
        <div class="inline-flex items-center sm:text-lg text-blue-100">
          ...
          <p>
            We just released 2.0 version! Check out the{" "}
            <a href="javascript:void(0)" class="underline hover:opacity-75">
              changelog
            </a>
            .
          </p>
        ...
        <div class="flex items-center ml-2">
          <button
            type="button"
            class="p-1 rounded inline-flex justify-center items-center focus:outline-none text-white opacity-75 hover:opacity-100 focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:opacity-75"
          >
            <svg
              class="hi-outline hi-x inline-block w-6 h-6"
              stroke="currentColor"
              fill="none"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
